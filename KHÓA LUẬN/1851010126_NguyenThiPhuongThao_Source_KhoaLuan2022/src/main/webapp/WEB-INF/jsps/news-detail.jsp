<%-- 
    ...
    Created on : 12 Oct 2021, 16:36:30
    Author     : ntpth
--%>
...
<%@taglib prefix="spring" uri="http://www.springframework.org/tags" %>
    <div class="row" style="background-color: #F8F8FF;">
        ...
        <div class="col-md-6">
            ...
            <c:url value="/news-detail" var="action" />

            <form:form method="post" action="${action}" modelAttribute="newsdetail" enctype="multipart/form-data">
